...
const IndexPage = () => (
  <div>
    ...
    <p>
      ...
      <Code code="https://github.com/aggarwalpulkit596/Pull-A-Code"/>
    </p>
    <h3>Step 2</h3>
    <p>
      ...
      <Code code="git clone https://github.com/YOUR_USERNAME/Pull-A-Code.git"/>
    </p>
   <h3>Step 3</h3>
    <p>
    ...
    <p>
      ...
      It should look like <b>YOUR_USER_NAME.md</b> <i>eg: aggarwalpulkit596.md </i><br/>
    ...
    <h3>Step 7</h3>
    <p>
      Now, open your web browser and goto the <a target="_blank" href="https://github.com/aggarwalpulkit596/Pull-A-Code"> original repository on GitHub</a>. If your changes has been pushed to your forked copy, You'll be able to see an option saying "New Pull Request" in the original repository.
